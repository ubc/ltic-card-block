...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./constants */ "./src/wp-card-block/constants.js");
...
function Placeholder({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
    ...blockProps,
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.__experimentalBlockVariationPicker, {
...
const populateTemplate = (targetBlocks, sourceBlockPool) => {
  return targetBlocks.map(targetBlock => {
    ...
    const matchIndex = sourceBlockPool.findIndex(b => {
      ...
      if (_constants__WEBPACK_IMPORTED_MODULE_6__.QUERY_LOOP_TRANSFORMS[targetBlock.name] === b.name) {
        return true;
      }
      return false;
    });
...
function ColumnsEditContainer({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {}), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("div", {
      ...innerBlocksProps
    })]
  });
}
...
/***/ "./src/wp-card-block/constants.js"
/*!****************************************!*\
  !*** ./src/wp-card-block/constants.js ***!
  \****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   QUERY_LOOP_TRANSFORMS: () => (/* binding */ QUERY_LOOP_TRANSFORMS)
/* harmony export */ });
/**
...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components */ "./src/wp-card-block/components.js");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./constants */ "./src/wp-card-block/constants.js");
...
function Edit(props) {
  ...
  const innerBlocks = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.store).getBlocks(clientId), [clientId]);
  const {
    replaceInnerBlocks
    ...
    if (isInQueryLoop && innerBlocks.length > 0) {
      ...
      const transformBlocks = blocks => {
        return blocks.map(block => {
          ...
          const transformTarget = _constants__WEBPACK_IMPORTED_MODULE_7__.QUERY_LOOP_TRANSFORMS[block.name];
          ...
          if (transformTarget) {
            ...
            if (block.name === 'core/heading') {
              if (!headingReplaced) {
                ...
                hasChanged = true;
                return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__.createBlock)(transformTarget, {
          ...
          if (block.innerBlocks.length > 0) {
            ...
            return (0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_5__.createBlock)(block.name, block.attributes, newInnerBlocks);
          }
          return block;
        });
      };
  ...
  const Component = hasInnerBlocks ? _components__WEBPACK_IMPORTED_MODULE_6__.ColumnsEditContainer : _components__WEBPACK_IMPORTED_MODULE_6__.Placeholder;
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"ltic/card-block","version":"0.1.0","title":"Card Block","category":"widgets","description":"A flexible card block that allows different layouts.","supports":{"html":false},"attributes":{"variationType":{"type":"string","default":"pattern-1"},"isInQueryLoop":{"type":"boolean","default":false}},"styles":[{"name":"default","label":"Default","isDefault":true},{"name":"cms-card","label":"CMS Card"},{"name":"ctlt-card","label":"CTLT Card"}],"usesContext":["queryId"],"textdomain":"wp-card-block","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","viewScript":"file:./view.js"}');
